    ...
    <section className="py-20 px-4" style={{ backgroundColor: 'var(--brand-50)' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-medium mb-4" style={{ color: 'var(--brand-900)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className={`material-card p-6 lg:p-8 animate-slide-up ${
                index === 0 ? '' :
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-3" style={{ color: 'var(--brand-900)' }}>
                {feature.title}
              </h3>
              ...
              <div 
                className="w-full h-0.5 mt-6 rounded-full"
