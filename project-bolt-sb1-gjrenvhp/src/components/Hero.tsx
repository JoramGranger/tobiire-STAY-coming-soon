...
const Hero = () => {
  ...
  useEffect(() => {
    // Set launch date to January 3rd, 2026
    const launchDate = new Date('2026-01-03T00:00:00');
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="animate-fade-in animate-text-glow">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-light text-white mb-4 animate-text-float">
            <span style={{ color: 'var(--brand-700)' }} className="font-medium">STAY</span>
            <span className="block text-2xl md:text-3xl lg:text-4xl mt-2 font-light animate-text-slide-in">
              by Tobiira IO
            </span>
          </h1>
        </div>

        <div className="animate-slide-up animate-delay-200 animate-text-fade-in">
          <p className="text-xl md:text-2xl text-white/90 mb-8 font-light animate-text-pulse">
            Modern short-stay hospitality management
          </p>
        </div>

        <div className="animate-slide-up animate-delay-400 animate-text-zoom-in">
          <h2 className="text-2xl md:text-3xl font-medium text-white mb-8 animate-text-shimmer">
